 ...
 */
public class ArmoredSkeletonAttack extends EnemyProjectileAttackAnimation {
     ...
     */
    public ArmoredSkeletonAttack(SpriteSheet spriteSheet, float startX, float startY,
