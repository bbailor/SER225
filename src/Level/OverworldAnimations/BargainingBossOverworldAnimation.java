 ...
 * </pre>
 */
public class BargainingBossOverworldAnimation extends OverworldAttackAnimation {
     ...
     */
    public BargainingBossOverworldAnimation(float x, float y, int duration) {
        super(x, y, duration);
    }
    ...
    private static SpriteSheet createBargainingBossSpriteSheet() {
        try {
            return new SpriteSheet(ImageLoader.load("Enemies/BargainingBossAttack.png"), 255, 255);
        } catch (Exception e) {
            System.err.println("Failed to load BargainingBossAttack.png: " + e.getMessage());
            // Fallback to solid color
            return new SpriteSheet(
                Utils.ImageUtils.createSolidImage(new java.awt.Color(200, 100, 255, 200), 255, 255),
                255, 255
            );
        }
    }
